 ...
 */
final class Version20230605160323 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE history (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, game_id INT NOT NULL, date DATE NOT NULL, content VARCHAR(255) NOT NULL, INDEX IDX_27BA704BA76ED395 (user_id), INDEX IDX_27BA704BE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
